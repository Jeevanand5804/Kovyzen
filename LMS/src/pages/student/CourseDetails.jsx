  ...
  return courseData ? (
    ...
    <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        {/* Review and Ratings */}
          <div className='flex items-center space-x-2 pt-3 pt-1 '>
                ...
                <p className='text-sm'>Course by <span className='text-blue-600 underline'>Kovyzen</span></p>  
                <div className='pt-8 text-gray-800'>
                  <h2 className='text-xl font-semibold'>Course Structure</h2>
                  <div className='pt-5'>
                    {courseData.courseContent.map((chapter,index)=>(
                      <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                        <div className='flex items-center justify-between px-4 py-4 cursor-pointer select-none' onClick={()=>toggleSection(index)}>
      ...
      {
              playerData ? 
              <YouTube videoId={playerData.videoId} opts={{playerVars:{autoplay:1, showinfo: 0}}} iframeClassName='w-full aspect-video' />
               :
        ...
        <div className='p-5'>
          ...
          <div className='pt-6'>
            <p className='md:text-xl text-lg font-medium text-gray-800'>Wat's in te course?</p>
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              <li>Lifetime access with free updates.</li>
              <li>Step-by-step, ands-on project guidance.</li>
